...
class QMixNet(nn.Module):
    def __init__(self, args):
        ...
        if args.two_hyper_layers:
            ...
            # 以hyper_w1作为权重的那层网络，其输入维度为args.n_agents，输出维度应该是隐藏层的维度即args.qmix_hidden_dim，则该网络权重
            #应该有args.n_agents * args.qmix_hidden_dim维。
    ...
    def forward(self, q_values, states):  # states的shape为(episode_num, max_episode_len， state_shape)
        ...
        w1 = torch.abs(self.hyper_w1(states))  # (1920, 160)  保证权重非负
