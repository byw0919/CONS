...
class Viewer(object):
    ...
    def _draw_box(self, env):
        ...
        for row, col in ridxes:
            ...
            if env._get_entity_with_pos(extend_pos)[0] == 3:  # box1-yellow
                boxes.append(
            ...
            elif env._get_entity_with_pos(extend_pos)[0] == 4:  # box2-red
                boxes.append(
                    pyglet.sprite.Sprite(
                        self.img_box2,
                        self.grid_size * col,
    ...
    def _draw_thing(self, env):
        ...
        for row, col in ridxes:
            extend_pos = env._to_extended_coordinates((row, col))
            if env._get_entity_with_pos(extend_pos)[0] == 1:  # coin
                sths.append(
                    pyglet.sprite.Sprite(
                        self.img_coin,
                        self.grid_size * col,
            ...
            elif env._get_entity_with_pos(extend_pos)[0] == 2:  # treasure
                sths.append(
                    pyglet.sprite.Sprite(
                        self.img_treasure,
                        self.grid_size * col,
